...
class GuideParty(Base):
    ...
    origin_landline_phone: Mapped[str] = mapped_column(String(40), default="")
    origin_whatsapp_phone: Mapped[str] = mapped_column(String(40), default="")
    origin_email: Mapped[str] = mapped_column(String(190), default="")
    origin_state_code: Mapped[str] = mapped_column(String(10), default="")
    origin_municipality_code: Mapped[str] = mapped_column(String(20), default="")
    origin_postal_code: Mapped[str] = mapped_column(String(10), default="")
    origin_colony_id: Mapped[str] = mapped_column(String(64), default="")
    origin_address_line: Mapped[str] = mapped_column(String(255), default="")
    destination_landline_phone: Mapped[str] = mapped_column(String(40), default="")
    destination_whatsapp_phone: Mapped[str] = mapped_column(String(40), default="")
    destination_email: Mapped[str] = mapped_column(String(190), default="")
    destination_state_code: Mapped[str] = mapped_column(String(10), default="")
    destination_municipality_code: Mapped[str] = mapped_column(String(20), default="")
    destination_postal_code: Mapped[str] = mapped_column(String(10), default="")
    destination_colony_id: Mapped[str] = mapped_column(String(64), default="")
    destination_address_line: Mapped[str] = mapped_column(String(255), default="")
